...
import { Zap, ArrowUp, Linkedin, Cpu, Instagram } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pb-16">
          ...
          <div className="md:col-span-5 space-y-6">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a 
                href="https://www.linkedin.com/company/airaspark-industries/" 
                target="_blank" 
                rel="noreferrer" 
              ...
              <a 
                href="https://www.instagram.com/airaspark_industries" 
                target="_blank" 
                rel="noreferrer" 
                className="w-9 h-9 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-[#A7B0C0] hover:text-[#4C8DFF] hover:border-[#4C8DFF]/50 hover:bg-[#4C8DFF]/10 transition-all cursor-pointer"
                aria-label="AiraSpark on Instagram"
              >
                <Instagram className="w-4.5 h-4.5" />
              </a>
              <a
  href="https://x.com/AiraSpark_IND"
  target="_blank"
  rel="noreferrer"
  className="w-9 h-9 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-[#A7B0C0] hover:text-[#4C8DFF] hover:border-[#4C8DFF]/50 hover:bg-[#4C8DFF]/10 transition-all cursor-pointer"
  aria-label="AiraSpark on X"
>
  <FaXTwitter className="w-4 h-4" />
          ...
          <div className="md:col-span-4 space-y-4">
            <h4 className="text-xs font-mono text-white uppercase tracking-widest font-semibold">CORE SERVICES</h4>
            <div className="grid grid-cols-1 gap-2.5">
              <a href="#solutions" onClick={(e) => handleLinkClick(e, 'solutions')} className="text-sm text-[#AAB7C4] hover:text-white transition-colors">
