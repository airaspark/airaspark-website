...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center pt-24 overflow-hidden select-none">
      {/* Canvas Layer */}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center mt-6">
        ...
        <motion.p
          ...
          className="mt-8 text-base sm:text-xl text-[#AAB7C4] max-w-2xl mx-auto font-light leading-relaxed tracking-wide"
        >
