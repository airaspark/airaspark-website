      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center mt-4 sm:mt-6">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center -space-x-2 sm:-space-x-3 items-center gap-y-3">
            ...
            <span className="w-full sm:w-auto text-[10px] sm:text-xs text-[#A7B0C0] font-mono sm:ml-3 font-medium uppercase tracking-wider text-center sm:text-left">Managed Devices</span>
          </div>
          </motion.div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <h4 className="text-base sm:text-lg font-bold font-display text-white mt-0.5">Enterprise-Grade Security</h4>
            </div>
          </div>
