...
export default function Solutions() {
  ...
  const solutionsData: Solution[] = [
    ...
    },
    {
      ...
      description: 'Autonomous Kubernetes clustering, Multi-region high availability schemes, infra-as-code automation, and strict container isolation policies.',
      icon: 'Cloud',
      metrics: '99.999% Service Level Guarantees',
      features: [
