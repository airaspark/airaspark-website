...
import { Technology } from '../landing-types';
import { 
  Database, 
  Terminal, 
  Cpu, 
...
export default function TechShowcase() {
  ...
  return (
    <section id="technologies" className="relative py-20 sm:py-28 bg-[#0B1220] overflow-hidden">
      {/* Visual separators */}
            ...
            <div className="mt-6 sm:mt-8 flex flex-col gap-3">
              {technologiesData.map((tech, idx) => (
                ...
                >
                  ...
                  {/* UPDATED: Container for both Gemini Sparkle and Chevron */}
                  <div className="flex items-center gap-2">
                    {/* The Gemini-style Sparkle Icon (Only shows when active) */}
                    {activeTech === idx && (
                      <motion.div
                      ...
                      >
                        <Sparkles className="w-4 h-4 text-[#4C8DFF] animate-pulse drop-shadow-[0_0_8px_rgba(76,141,255,0.8)]" />
                      </motion.div>
                    )}
