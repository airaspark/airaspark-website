...
export default function TechShowcase() {
  ...
  const technologiesData: Technology[] = [
    ...
    },
    {
      ...
      category: 'iot',
      description: 'High-frequency telemetry parsers, secure hardware keys, embedded real-time event firmware, and light-weight connection protocols.',
      proficiencyGauge: 85,
    },
    {
  ...
  return (
    <section id="technologies" className="relative py-28 bg-[#07111F]">
      {/* Visual separators */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-xs font-mono uppercase tracking-widest text-[#00AEEF] font-bold">Tech Stack Showcase</p>
            </div>
              ...
              {technologiesData.map((tech, idx) => (
                <button
                  ...
                  className={`w-full text-left px-5 py-3.5 rounded-xl flex items-center justify-between transition-all duration-300 border cursor-pointer ${
                    activeTech === idx
                      ? 'bg-[#0B1E36] border-[#00AEEF]/40 text-white shadow-[0_0_15px_rgba(0,174,239,0.15)]'
                      : 'bg-[#020813]/60 border-white/5 text-[#AAB7C4] hover:text-white hover:border-white/10'
                  }`}
                >
                  <div className="flex items-center gap-3.5">
                    <div className={`p-2 rounded-lg transition-colors ${
                      activeTech === idx ? 'bg-[#00AEEF]/20 text-[#00AEEF]' : 'bg-white/5 text-[#AAB7C4]'
                    }`}>
                  ...
                  <ChevronRight className={`w-4 h-4 transition-transform duration-300 ${
                    activeTech === idx ? 'translate-x-1 text-[#00AEEF]' : 'text-neutral-500'
                  }`} />
                </button>
              ))}
            </div>
          ...
          <div className="lg:col-span-7">
            <div className="glass-panel rounded-2xl p-8 sm:p-10 relative overflow-hidden shadow-[0_15px_40px_rgba(2,8,19,0.5)] cyber-border-tl cyber-border-br min-h-[440px] flex flex-col justify-between">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    <span className="px-3 py-1 bg-[#00AEEF]/10 border border-[#00AEEF]/20 rounded-full text-[10px] font-mono text-[#00AEEF] tracking-widest uppercase">
                      Category // {technologiesData[activeTech].category}
                    </span>
                    <span className="text-xs font-mono text-[#AAB7C4]/50">SECURE SHELL // SSH-V2</span>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-4 text-[#AAB7C4] text-sm sm:text-base leading-relaxed tracking-wide font-light">
                  ...
                  <div className="space-y-2 pt-4">
                    <div className="flex items-center justify-between text-xs font-mono">
                      ...
                      <span className="text-[#00AEEF] font-bold">{technologiesData[activeTech].proficiencyGauge}% DEPLOYED</span>
                    </div>
                    {/* Gauge Visual Bar */}
                    <div className="h-2 bg-white/5 rounded-full overflow-hidden border border-white/5">
                      <motion.div
                        ...
                        className="h-full bg-gradient-to-r from-[#00AEEF]/40 to-[#00AEEF] shadow-[0_0_10px_rgba(0,174,239,0.5)]"
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-6 border-t border-white/5">
                    <div className="p-3 bg-[#020813]/60 rounded-xl border border-white/5">
                      <span className="text-[10px] font-mono text-[#AAB7C4]/60 block uppercase">Protocol Priority</span>
                      <span className="text-sm font-semibold font-display text-white mt-1 block">CRITICAL</span>
                    </div>
                    <div className="p-3 bg-[#020813]/60 rounded-xl border border-white/5">
                      <span className="text-[10px] font-mono text-[#AAB7C4]/60 block uppercase">Compliance Range</span>
                      <span className="text-sm font-semibold font-display text-white mt-1 block">ENTERPRISE</span>
                    </div>
                    <div className="p-3 bg-[#020813]/60 rounded-xl border border-white/5 col-span-2 sm:col-span-1">
                      <span className="text-[10px] font-mono text-[#AAB7C4]/60 block uppercase">Telemetry Status</span>
              ...
              <div className="mt-6 p-4 rounded-xl bg-[#020813] border border-white/5 font-mono text-[10px] text-[#AAB7C4]/60 space-y-1">
                <span className="text-[#00AEEF] block">&gt; shreyank@airaspark:~# inspect --stack {technologiesData[activeTech].category}</span>
